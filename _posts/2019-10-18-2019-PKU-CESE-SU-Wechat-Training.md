...
headImage: https://file.moetu.org/images/2020/02/20/06a949f0329efaa1f4b63851e858ffda488a7039761c5827.jpg
js: bilibili
...
环院学生会微信推送使用“**秀米**”（[https://xiumi.us/](https://xiumi.us/)）作为排版工具。开始之前，你需要拥有一个秀米账号，点击右上方“登录”可以快速注册账号。在补充个人信息之后，即可开始推送之旅。另外，为了确保浏览器兼容，请尽量使用Chrome浏览器。
...
![新图文的初始设置\|1920px](https://file.moetu.org/images/2020/02/20/bfd3c229364a9507694c1d22b7a299b2c050bb3636fdadd7.png) 
...
![图片截取比例](https://file.moetu.org/images/2020/02/20/5ed36e39eb37e933c9a92ea041798d9a4d42047d2262df38.png)

![标题、摘要、封面示例\|429px](https://file.moetu.org/images/2020/02/20/507d6d3ed1bab1705a5f1db148457726ad7870eed3f7034b.png)

![基础格式示例\|303px](https://file.moetu.org/images/2020/02/20/5cf5e5d19c43ed1cb953309eb54d42fc5b5575a1c8477fc0.png)
...
![秀米提供的工具栏\|646px](https://file.moetu.org/images/2020/02/20/009165057fcf465400b42345f77b268af31da76e981912a2.png)
...
推荐配色网站：Color Scheme Designer 3（[http://colorschemedesigner.com/csd-3.5/](http://colorschemedesigner.com/csd-3.5/)，有中文版[http://www.peise.net/tools/web/](http://www.peise.net/tools/web/)）。从色环选择合适的颜色，然后选择配色方案（“单色搭配”“互补色搭配”等），再从“色彩列表”中复制色彩代码，用Word的“替换”功能将代码处理成“#ABCDEF;”的格式，之后就可以导入秀米的配色板了。导入结果如图6所示。

![导入配色板\|302px](https://file.moetu.org/images/2020/02/20/496e8b2fa9ed0c85a126d30b495e56663b5cbc43492b6f63.png)

对于秀米提供的模板，如果主色调与所选的配色板相差较大，可以自行修改模板的配色，如图7所示。

![修改模板配色\|719px](https://file.moetu.org/images/2020/02/20/ac147f41db04d758555d0bef73ecc9fa36846dfda1588852.png)
...
2. **专业图片提供网站搜索**。此处推荐一些免费的无版权图片网站，如pixabay（[https://pixabay.com/zh/](https://pixabay.com/zh/)，提供照片、矢量图、插画、视频等）、Public domain vectors（[https://publicdomainvectors.org/zh-CHS/](https://publicdomainvectors.org/zh-CHS/)，提供矢量图）、SVG Repo（[https://www.svgrepo.com/](https://www.svgrepo.com/)，提供矢量图标）、Free vector icons（[https://www.flaticon.com/](https://www.flaticon.com/)，提供矢量图标）等。其优点是图片丰富，分辨率高，但是一般缺乏版权图片（如商标、人物图片等）。
...
微信推送中仅可插入**腾讯视频**（[https://v.qq.com/](https://v.qq.com/)）网站的视频，如果需要插入自制视频，需要提前上传腾讯视频网站。首先需要在腾讯视频注册并登录账号，完成实名认证后上传视频。待审核完毕后，在视频页面的“分享”处获取“**通用代码**”。在秀米页面的左侧选择“组件”→“视频”，然后粘贴通用代码，即可插入视频。

![获取视频通用代码\|780px](https://file.moetu.org/images/2020/02/20/93d8d670c0815dbabfed46929da677014431ca51a3020b5e.png)
...
![已调整格式和未调整格式的显示效果\|80px](https://file.moetu.org/images/2020/02/20/f6565b333265871f8e56baab7db0e0c4ec63661d6895e78f.png)
...
![用HTML代码输入上下标\|1568px](https://file.moetu.org/images/2020/02/20/bc990982f77ebb860ff2c3a6ca70aecbe842c28aeb86b72b.png)

### 2.5. 将链接变为二维码

由于微信推送无法直接插入链接，因此扫描二维码是从推送跳转链接的一个重要方式。一些网站（如“问卷星”等）会提供二维码，但这些二维码可能存在分辨率不足、不美观等问题，可能需要重新制作新的二维码。

推荐一个网站：草料二维码（[https://cli.im/](https://cli.im/)），既可以生成二维码也可以读取二维码。

读取二维码：对于已有的二维码，利用“草料二维码扫描器”（[https://cli.im/deqr](https://cli.im/deqr)）上传二维码图片，可以获取二维码的文本内容。
